      ...
      >
        <div className="flex flex-wrap items-center gap-2">
          ...
          {exampleClaims.map((example) => (
            ...
            disabled={requestState !== "idle" || (testingMode && example.label !== "Unknown water source")}
            aria-disabled={requestState !== "idle" || (testingMode && example.label !== "Unknown water source")}
            title={requestState !== "idle" ? "Start over to choose another example" : testingMode && example.label !== "Unknown water source" ? "Only Unknown water source is available in testing mode" : undefined}
        ...
        <div className="mt-5">
          ...
          <p className="mt-1 text-sm text-muted-foreground text-pretty">
            Use your own words. Include what was damaged and how, but only what you actually know. Your description must fit one of the {supportedClaimTypeValues.length} supported claim categories. To see which categories are supported, click the <strong>&quot;Supported claim categories&quot;</strong> section above.
          </p>
          <textarea
            id="narrative"
            name="narrative"
